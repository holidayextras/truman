...
module.exports = {
  ...
  monkeyPatchXHR() {
    ...
    RealXMLHttpRequest.prototype.open = function() {
      ...
      if (args[args.length - 1] instanceof XMLHttpRequest) {
  ...
  unMonkeyPatchXHR() {
    XMLHttpRequest.prototype.open = RealXMLHttpRequest.prototype.open;
    XMLHttpRequest.prototype.send = RealXMLHttpRequest.prototype.send;
  }
